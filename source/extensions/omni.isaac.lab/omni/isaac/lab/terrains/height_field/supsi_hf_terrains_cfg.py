...
@configclass
class SupsiSingleCubeDownTerrainCfg(HfTerrainBaseCfg):

    function = supsi_hf_terrains.supsi_single_cube_down_terrain
...
@configclass
class SupsiWallTerrainCfg(HfTerrainBaseCfg):

    function = supsi_hf_terrains.supsi_wall_terrain
