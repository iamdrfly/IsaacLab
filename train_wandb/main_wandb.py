...
def train():
    ...
    params = {
        ...
        "vacuum_action_rate_reward_scale": config.vacuum_action_rate_reward_scale,
...
sweep_config = {
    ...
    "parameters": {
        "theta_marg_sum_reward_scale": {"min": 0.0001, "max": 0.1},
        "action_scale": {"min": 0.05, "max": 0.5},
        "stumble_reward_scale":{"min": -5., "max": -1.},
        "vacuum_action_rate_reward_scale": {"min": -0.5, "max": -0.001},
        "joint_torque_reward_scale": {"min": -0.00001*10, "max": -0.00001*2},
        "base_acc_reward_scale":{"min": -0.001, "max": -0.001/5.},

        # "position_tracking_reward_scale": {"min": 8., "max": 15.},
        # "heading_tracking_reward_scale": {"min": 4., "max": 6.},
        # "joint_vel_reward_scale": {"min": -0.001, "max": -0.001/10.},
        ...
        # "action_rate_reward_scale":{"min": -0.01*10, "max": -0.01/10.},
        # "max_feet_contact_force":{"min": 400., "max": 700.},
        # "feet_contact_force_reward_scale":{"min": -0.00001*100, "max": -0.00001/100.},
        # "wait_time":{"min": 0.1, "max": 0.3},
        # "dont_wait_reward_scale":{"min": -1.5, "max": -0.5},
...
# Definiamo lo sweep
sweep_id = wandb.sweep(sweep_config, project="isaaclab-grace-action-scale-and-vacuum-curriculum")
